...
ios:
	...
	open ../intervaluebuilds/project-IOS/platforms/ios/InterValue-2.0.1-testnet.xcodeproj
...
win32:
	grunt.cmd desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0.1-testnet/win32/
	grunt.cmd inno32
...
linux64:
	grunt desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0.1-testnet/linux64/
	grunt linux64

osx64:
	grunt desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0.1-testnet/osx64/InterValue-2.0.1-testnet.app/Contents/Resources/app.nw/
	grunt dmg