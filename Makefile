...
ios:
	...
	open ../intervaluebuilds/project-IOS/platforms/ios/InterValue-2.0-testnet.xcodeproj
...
android:
	...
	mv ../intervaluebuilds/project-ANDROID/platforms/android/build/outputs/apk/android-debug.apk ../intervaluebuilds/InterValue-2.0-testnet.apk
...
win32:
	grunt.cmd desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0-testnet/win32/
	grunt.cmd inno32
...
linux64:
	grunt desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0-testnet/linux64/
	grunt linux64

osx64:
	grunt desktop
	cp -rf node_modules ../intervaluebuilds/InterValue-2.0-testnet/osx64/InterValue-2.0-testnet.app/Contents/Resources/app.nw/
	grunt dmg