	...
	grunt.initConfig({
		...
		copy: {
			...
			node_modules: {
				expand: true,
				src: 'node_modules/**',
				dest: '../intervaluebuilds/InterValue-2.0.1-testnet/win64/'
			},
				...
				files: [
					{
						...
						dest: '../intervaluebuilds/InterValue-2.0.1-testnet/linux32/',
						flatten: true,
						filter: 'isFile',
						options: { timestamp: true, mode: true }
					},
					{
						...
						dest: '../intervaluebuilds/InterValue-2.0.1-testnet/linux64/',
						flatten: true,
						filter: 'isFile',
						options: { timestamp: true, mode: true }
					},
		...
		nwjs: {
			options: {
				...
				appName: 'InterValue-2.0.1-testnet',
				...
				macPlist: {
					CFBundleURLTypes: [{
						CFBundleURLName: 'InterValue-2.0.1-testnet action',
		...
		compress: {
			...
			linux64: {
				options: {
					archive: '../intervaluebuilds/InterValue-2.0.1-testnet-linux64.zip'
				},
				expand: true,
				cwd: '../intervaluebuilds/InterValue-2.0.1-testnet/linux64/',
				src: ['**/*'],
				dest: 'InterValue-2.0.1-testnet-linux64/'
			}
		},
		browserify: {
			dist: {
